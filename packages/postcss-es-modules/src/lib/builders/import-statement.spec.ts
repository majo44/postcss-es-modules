...
describe('import-statement', () => {
    it('without params, should generate esm import', () => {
        ...
        expect(builder).calledWith('import { injectStyles } from \'css-es-modules\';\n', node);
    });
    it('should generate cjs import', () => {
        const builder = fake();
        const node: any = {}
        buildImportInjectStylesStatement(node, builder, { moduleType: 'cjs' });
        expect(builder).calledWith('const { injectStyles } = require(\'css-es-modules\');\n', node);
    });
    ...
    it('should generate relative import if eject sibling', () => {
        ...
        expect(builder).calledWith('import { injectStyles } from \'../c/inject-styles\';\n', node);
    });
    ...
    it('should generate relative import if eject down', () => {
        ...
        expect(builder).calledWith('import { injectStyles } from \'../inject-styles\';\n', node);
    });
    ...
    it('should generate relative import if eject up', () => {
        ...
        expect(builder).calledWith('import { injectStyles } from \'./d/inject-styles\';\n', node);
    });
